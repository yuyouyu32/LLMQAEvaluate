...
# $ python .\Scores.py --answers "./Answers/gpt4_a.jsonl" --answers_key GPT4_A --result "./Scores/gpt4_scores"
# $ python .\Scores.py --answers "./Answers/gpt4_a_v2.jsonl" --answers_key GPT4_A --result "./Scores/gpt4_scores_v2"
# $ python .\Scores.py --answers "./Answers/vicuna_a.jsonl" --answers_key Vicuna_A --result "./Scores/vicuna_scores"
# $ python .\Scores.py --answers "./Answers/Vicuna13B-V1.3-langchain-answer.jsonl" --answers_key 'LLM-A' --result "./Scores/vicuna_scores_V1.3"
# $ python .\Scores.py --answers "./Answers/WizardLM-13B-V1.0-langchain-answer.jsonl" --answers_key 'LLM-A' --result "./Scores/WizardLM-13B-V1.0_scores"
# $ python .\Scores.py --answers "./Answers/WizardLM-7B-V1.0-langchain-answer.jsonl" --answers_key 'LLM-A' --result "./Scores/WizardLM-7B-V1.0_scores"
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate answers against key labels")

    parser.add_argument("--label",default="./Answers/QA.jsonl", type=str, help="Path to label file")
